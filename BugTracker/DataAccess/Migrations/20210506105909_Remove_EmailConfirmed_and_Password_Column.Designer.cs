...
namespace DataAccess.Migrations
{
    ...
    [Migration("20210506105909_Remove_EmailConfirmed_and_Password_Column")]
    partial class Remove_EmailConfirmed_and_Password_Column
    {
            ...
            modelBuilder.Entity("Domain.Ticket", b =>
                {
                    ...
                    b.HasOne("Domain.TicketPriority", "TicketPriority")
                        .WithMany("Tickets")
                        .HasForeignKey("TicketPriorityId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Domain.TicketStatus", "TicketStatus")
                        .WithMany("Tickets")
